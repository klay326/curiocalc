    ...
    <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8">
      ...
      {(user?.is_superuser || user?.is_curator) && (
        <Link
          ...
          className="hidden md:flex fixed bottom-6 right-6 z-40 w-12 h-12 bg-amber-400 hover:bg-amber-300 text-zinc-950 rounded-full shadow-lg items-center justify-center text-2xl font-bold transition-colors"
